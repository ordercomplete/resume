...
router.get('/shopcart', function (req, res) {
  ...
  res.render('shopcart', {
    ...
    goodsBlock: [
      {
        image: 'https://picsum.photos/111/111',
      ...
      {
        image: 'https://picsum.photos/113/113',
      ...
      {
        image: 'https://picsum.photos/114/114',
        name: 'Навушники Sony WH-1000XM4',
        description:
          'Bluetooth 5.0, активне шумозаглу- шення, 30 годин автономної роботи, сенсорне управління, вага 254 г.',
        price: { title: 'Ціна', value: '25 000 ₴' },
    ...
    goodsOtherBlock: {
      ...
      cards: [
        ...
        {
          image: 'https://picsum.photos/402/201',
          title: 'MacBook Pro',
          description:
            "Apple's high-end laptop features a 16-inch Retina display, powerful M1 Pro or M1 Max chip, and up to 64GB of RAM.",
          isHot: true,
        ...
        {
          image: 'https://picsum.photos/404/202',
          title: 'AirPods Pro',
          description:
            "Apple's premium wireless earbuds feature active noise cancellation, a customizable fit, and up to 4.5 hours of listening time.",
          isHot: true,
      ...
      itemList: [
        {
          ...
          images: ['https://picsum.photos/101/101'],
          button: {
            text: 'Детальніше',
            link: 'https://www.youtube.com/',
            isPrimary: true,
    ...
    goodsList: [
      {
        ...
        characteristics: [
          { title: 'Діагональ', value: '14' },
          { title: 'Екран', value: 'IPS' },
          {
            title: 'Процесор',
            value: 'Intel Core i9-1135G7',
          },
          { title: 'Оперативна пам’ять', value: '32 ГБ' },
        ],
      },
      {
        img: 'https://picsum.photos/400/200',
      ...
      },
      {
        ...
        characteristics: [
          ...
          { title: 'Оперативна пам’ять', value: '16 ГБ' },
        ],
      },
      {
        img: 'https://picsum.photos/400/200',
        ...
        characteristics: [
          { title: 'Діагональ', value: '17' },
          { title: 'Екран', value: 'IPS' },
          {
            title: 'Процесор',
            value: 'Intel Core i7-1135G7',
          },
          { title: 'Оперативна пам’ять', value: '8 ГБ' },
        ],
      },
